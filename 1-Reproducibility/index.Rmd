...
![](figures/DistributedVCS.png)

[Jenny Bryan's git tutorial](git@github.com:dicook/Monash-R_2017.git)

## Key github commands

- `clone` Get a local copy of the repo
- `pull` Get a fresh copy or changed files from the server
- `add` Add a new file to be tracked
- `commit` Let server know you want to merge changes
- `push` Upload your changed files to the server

## github structure

- README.md: Great place to do weekly updates to your advisor
- code: your thesis, code, data
- wiki: Discussion board to map out project, hash out ideas, document progress
- issues: Good place for you and advisor to list next steps, items to be completed, create, complete, keeps work ticking along in an organised 

## Your turn

- Go to [github.com](https://github.com)
- Create an account
- Give the name to one of Earo, Wenjing or Stuart, so I can add you to the repo for this class
...
(Slides and material can be found at [http://dicook.github.io/Monash-R/](http://dicook.github.io/Monash-R_2017/).)
...
1. Create a new Rmd file, that will read 10 days of exchange rates from, and makes a plot, or some summary statistics, or fit some model of the data
2. Add and commit the file to the course github repo, in the "student_files" directory
3. Create a new issue of something that you want me to add to/edit in your document
